(function() {	
	...
	var Slide = function(node, idx) {
		...
		_makeBuildList: function() {
			...
			this.firstElt = this._buildList.shift();
		},
		_runAutos: function() {
		...
		buildNext: function() {
			...
			var current = this._buildList[0];
			if (current.previousElementSibling)
				removeClass(current.previousElementSibling, "current");
			addClass(current, "current");	
			removeClass(this.firstElt,  'to-build');
	...
	// codemirror 
	/*
	var codeBlocks = queryAll(".slides .html-source");
	for (var i = 0; i < codeBlocks.length; i++) {				
		CodeMirror.fromTextArea(codeBlocks[i], {
			height : "400px",
			parserfile: ["parsexml.js", "parsecss.js", "tokenizejavascript.js", "parsejavascript.js", "parsehtmlmixed.js"],    
			path: "codemirror/js/",
			stylesheet: ["http://fonts.googleapis.com/css?family=Droid+Sans|Droid+Sans+Mono", "codemirror/css/xmlcolors.css", "codemirror/css/jscolors.css", "codemirror/css/csscolors.css", "custom.css"]
	    });
	}
	codeBlocks = queryAll(".slides .javascript-source");
	for (var i = 0; i < codeBlocks.length; i++) {		
		CodeMirror.fromTextArea(codeBlocks[i], {
			height : "120px",
			parserfile: ["tokenizejavascript.js", "parsejavascript.js"],
			path: "codemirror/js/",
			stylesheet: ["http://fonts.googleapis.com/css?family=Droid+Sans|Droid+Sans+Mono", "codemirror/css/jscolors.css", "custom.css"]
		});
	}
	codeBlocks = queryAll(".slides .javascript-source-long");
	for (var i = 0; i < codeBlocks.length; i++) {		
		CodeMirror.fromTextArea(codeBlocks[i], {
			height : "250px",
			parserfile: ["tokenizejavascript.js", "parsejavascript.js"],
	...
	codeBlocks = queryAll(".slides .javascript-source-longest");
	for (var i = 0; i < codeBlocks.length; i++) {		
		CodeMirror.fromTextArea(codeBlocks[i], {
			height : "340px",
			parserfile: ["tokenizejavascript.js", "parsejavascript.js"],
